...
def _cover_block(src, alt, class_name, dim_ratio, inner_markup, qa_flag):
    ...
    """
    if dim_ratio in (0, 50):
        dim_classes = "has-background-dim"
    else:
        dim_classes = f"has-background-dim-{dim_ratio} has-background-dim"
    ...
    return (
        ...
        '"overlayColor":"primary","align":"full","className":"' + class_name + '"} -->\n'
...
def block_to_gutenberg(block):
    ...
    if t == "hero":
        ...
        return _cover_block(
            src, alt, "migration-hero", 60, inner_markup,
