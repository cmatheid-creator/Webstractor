...
Generated: 2026-08-28 00:09 UTC
...
- **Navigation menu** (20 item(s), matching the site's real nav structure including page hierarchy) included as a WordPress menu named "Main Menu", ready on import. **One manual step required**: WordPress doesn't auto-assign an imported menu to a theme location — go to Appearance → Menus (or the Site Editor's Navigation block for a block theme) and assign "Main Menu" to your primary menu location.
